       ...
       <div class="model col-10" style="border-radius: 20px;">
            ...
            <form action="" method="post" class="pl-5 pr-5 pb-5 pt-2">
                <div class="mb-4" align="center">
                    ...
                    <input type="text" class="text-center" name="username" placeholder="Your Rollnumber" required>
                </div>

                <div class="mb-4" align="center">
                    <!-- <label for="email">Password</label><br> -->
                    <input type="password" class="text-center" id="" name="password" placeholder="Your Password" required>
            ...
            <hr><p class="mt-4">Don't have an account,  <a href="registration.php" class="text-grad">Create an account</a></p>
            </form>
